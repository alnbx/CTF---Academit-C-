...
#define PLAYER_END_FILE 7
enum userChoice			  { CHOOSE_NAMES = 1, START_GAME = 2, REVERSED_MODE = 3, RESET_SCORE = 4, RECORD_GAME = 5, EXIT = 9 };
enum userChoiceSecondMenu { RETURN_TO_GAME = 1, START_AGAIN = 2, MAIN_MENU = 8, EXIT_GAME = 9 };
enum types				  { BLANK = 0, CHECK1 = 1, CHECK2 = 2, CHECK3 = 3, FlgA = 4, FR = 5, FlgB = 6, CHECK7 = 7, CHECK8 = 8, CHECK9 = 9, SEA = 10 , CHECKERERROR = 11, _typesSize = 12};
...
enum fileMoves			  {TOOL = 0, COL = 1, ROW = 2, SINGLE_MOVE = 3};